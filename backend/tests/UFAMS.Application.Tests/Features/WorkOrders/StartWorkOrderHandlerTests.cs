...
namespace UFAMS.Application.Tests.Features.WorkOrders.StartWorkOrder;

public class StartWorkOrderHandlerTests
{
    [Fact]
    public async Task Handle_WithAssignedWorkOrder_StartsWorkOrder()
    {
        // Arrange
        var tree =
    ...
    [Fact]
    public async Task Handle_WithOpenWorkOrder_ThrowsInvalidOperationException()
    {
        // Arrange
        var tree =
            TestDataFactory.CreateTree();
